%%
wavFiles = 'D:\Sanjeev\speech_recognition\Testnew2\';          %  Specify data folder
...
disp(folder_content(k,1).name);
  xlswrite('D:\Sanjeev\speech_recognition\ttest2_features.xlsx',c,'Sheet1',num2str(k));   %   Writing data to excel spreadsheet
